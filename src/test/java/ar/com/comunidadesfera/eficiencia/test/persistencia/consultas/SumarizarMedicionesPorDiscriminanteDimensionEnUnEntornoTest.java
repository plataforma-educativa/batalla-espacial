...
public class SumarizarMedicionesPorDiscriminanteDimensionEnUnEntornoTest 
    ...
    public void sumarizaDosMedicionesParaCadaUnoDeLosDosDiscriminantesEnElEntorno() {
        ...
        assertThat("items", items, contains(itemReporteQue().tieneValor(closeTo(091.0, 0.01)),
                                            itemReporteQue().tieneValor(closeTo(009.0, 0.01)),
                                            itemReporteQue().tieneValor(closeTo(384.0, 0.01)),
                                            itemReporteQue().tieneValor(closeTo(020.0, 0.01))));
    }
